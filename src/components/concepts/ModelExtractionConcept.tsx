        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-cyan-300 mt-2">Discover how attackers steal proprietary AI models through strategic querying</p>
            </div>
            {onStartChallenge && (
              <button
    ...
    <section>
      ...
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        ...
        <div className="bg-blue-500/20 border border-blue-500/50 rounded-lg p-4">
          <p className="text-sm font-semibold mb-2 text-blue-300">OWASP Classification: LLM10</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-red-500/50 rounded-lg p-6">
          ...
          <div className="bg-black/30 rounded-lg p-4 mb-4">
            <p className="text-xs font-semibold mb-2 text-cyan-400">Attack Process:</p>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-6">
          ...
          <div className="bg-black/30 rounded-lg p-4 mb-4">
            <p className="text-xs font-semibold mb-2 text-cyan-400">Attack Requirements:</p>
    ...
    <section>
      ...
      <div className="space-y-6">
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-cyan-400 mb-2">DeepSeek vs OpenAI (2024)</h3>
          <div className="space-y-2 text-gray-200">
            <p><strong className="text-cyan-400">Attack Vector:</strong> DeepSeek, a Chinese AI company, allegedly
            ...
            <p><strong className="text-cyan-400">Impact:</strong> DeepSeek successfully created a competitive LLM
            ...
            <p><strong className="text-cyan-400">Financial Cost:</strong> Estimated $100+ million in lost competitive
            ...
            <p><strong className="text-cyan-400">Outcome:</strong> OpenAI enhanced rate limiting, implemented
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-cyan-400 mb-2">Amazon Rekognition Extraction (2019)</h3>
          <div className="space-y-2 text-gray-200">
            <p><strong className="text-cyan-400">Attack Vector:</strong> Security researchers demonstrated extracting
            ...
            <p><strong className="text-cyan-400">Impact:</strong> The substitute model achieved over 90% fidelity to
            ...
            <p><strong className="text-cyan-400">Financial Cost:</strong> No direct financial impact as this was
            ...
            <p><strong className="text-cyan-400">Outcome:</strong> Amazon adjusted Rekognition API to reduce precision
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-cyan-400 mb-2">ML Model Extraction Challenge (2020)</h3>
          <div className="space-y-2 text-gray-200">
            <p><strong className="text-cyan-400">Attack Vector:</strong> Academic competition where participants
            ...
            <p><strong className="text-cyan-400">Impact:</strong> Multiple teams successfully extracted models with
            ...
            <p><strong className="text-cyan-400">Financial Cost:</strong> Demonstrated that models worth millions in
            development costs could be stolen for {'<'} $1,000 in API query costs.</p>
            <p><strong className="text-cyan-400">Outcome:</strong> Competition results led to development of new
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <span className="text-gray-200">
              <strong className="text-cyan-400">Black-Box Threat:</strong> Attackers can steal model functionality
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Cost Asymmetry:</strong> Models worth millions to train can be
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Two Attack Types:</strong> Functionality extraction recreates
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Confidence Scores Leak Information:</strong> Returning probability
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Active Learning Amplifies Efficiency:</strong> Adaptive query
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Real-World Impact:</strong> DeepSeek's alleged extraction of GPT-4,
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Rate Limiting Insufficient Alone:</strong> Attackers can spread
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
            <span className="text-gray-200">
              <strong className="text-cyan-400">Enables Secondary Attacks:</strong> Extracted models can be used
  ...
  <div className="space-y-8">
    ...
    <section>
      ...
      <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-4 mb-6">
        <p className="text-sm font-semibold text-red-300 mb-3">ATTACK CODE - Educational Demonstration</p>
...
# The substitute now replicates victim's functionality without accessing training data!`}
      ...
      <div className="bg-green-500/20 border border-green-500/50 rounded-lg p-4">
        <p className="text-sm font-semibold text-green-300 mb-3">DEFENSE CODE - Rate Limiting & Monitoring</p>
        <div className="bg-slate-900 rounded-lg p-4 font-mono text-sm overflow-x-auto">
          <pre className="text-gray-300">
...
print(f"Query reduction: {(1 - (50 + 10*30)/len(X_test)):.1%}")`}
        ...
        <div className="mt-3 text-sm text-gray-300">
          <p><strong className="text-cyan-400">Efficiency Gain:</strong> Active learning can achieve {'>'} 95% extraction
      ...
      <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-cyan-400">Layer 1 - Access Control:</strong>
              <span className="text-gray-300"> Strong authentication, verified accounts, billing requirements</span>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="bg-cyan-500/20 rounded-full p-1 mt-0.5">
            ...
            <div>
              <strong className="text-cyan-400">Layer 2 - Rate Limiting:</strong>
              <span className="text-gray-300"> Per-user/IP quotas, time-based windows, graduated pricing</span>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="bg-cyan-500/20 rounded-full p-1 mt-0.5">
            ...
            <div>
              <strong className="text-cyan-400">Layer 3 - Output Manipulation:</strong>
              <span className="text-gray-300"> Reduce precision, add noise, return only top-1 predictions</span>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="bg-cyan-500/20 rounded-full p-1 mt-0.5">
            ...
            <div>
              <strong className="text-cyan-400">Layer 4 - Monitoring:</strong>
              <span className="text-gray-300"> Anomaly detection, pattern analysis, behavioral alerts</span>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="bg-cyan-500/20 rounded-full p-1 mt-0.5">
            ...
            <div>
              <strong className="text-cyan-400">Layer 5 - Legal Protection:</strong>
              <span className="text-gray-300"> Watermarking, terms of service, DMCA provisions, IP enforcement</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div className="space-y-8">
    <section>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-cyan-400 mb-2">NIST AI Risk Management</h3>
          <p className="text-gray-300 text-sm mb-3">
      ...
      <div className="space-y-4">
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <p className="text-sm text-gray-300">
            [1] Tramer, F., Zhang, F., Juels, A., Reiter, M. K., & Ristenpart, T. (2016). <strong className="text-cyan-400">Stealing
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <p className="text-sm text-gray-300">
            [2] Orekondy, T., Schiele, B., & Fritz, M. (2019). <strong className="text-cyan-400">Knockoff Nets:
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <p className="text-sm text-gray-300">
            [3] Chandrasekaran, V., Chaudhuri, K., Giacomelli, I., Jha, S., & Yan, S. (2020). <strong className="text-cyan-400">Exploring
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <p className="text-sm text-gray-300">
            [4] Krishna, K., Tomar, G. S., Parikh, A. P., Papernot, N., & Iyyer, M. (2020). <strong className="text-cyan-400">Thieves
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <p className="text-sm text-gray-300">
            [5] Uchida, Y., Nagai, Y., Sakazawa, S., & Satoh, S. (2017). <strong className="text-cyan-400">Embedding
    ...
    <section>
      ...
      <div className="space-y-4">
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <h3 className="text-md font-semibold text-cyan-400 mb-2">ISACA 2025 Report: DeepSeek Model Extraction</h3>
          <p className="text-sm text-gray-300">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
          <h3 className="text-md font-semibold text-cyan-400 mb-2">Financial Times: Chinese AI Model Theft Investigation</h3>
          <p className="text-sm text-gray-300">
    ...
    <section>
      ...
      <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-yellow-300 mb-3">Legal Framework</h3>
        <div className="space-y-2 text-sm text-gray-300">
          <p>
            <strong className="text-yellow-400">Intellectual Property Theft:</strong> Model extraction violates
          ...
          <p>
            <strong className="text-yellow-400">Terms of Service Violations:</strong> Nearly all ML APIs explicitly
            prohibit model extraction in their terms. Violations can result in account termination, legal action,
            and financial liability.
          </p>
          <p>
            <strong className="text-yellow-400">Ethical Research:</strong> Academic research on extraction should
