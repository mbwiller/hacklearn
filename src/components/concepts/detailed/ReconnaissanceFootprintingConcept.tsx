        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-lg">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-bold">Reconnaissance & Footprinting</h1>
              <p className="text-emerald-600 dark:text-emerald-400 mt-2">Master the critical first phase of penetration testing and cyber attacks</p>
            </div>
          </div>
  ...
  <div className="space-y-8">
    ...
    <section>
      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6 space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Reconnaissance is divided into two main categories: <strong className="text-emerald-600 dark:text-emerald-400">passive reconnaissance</strong> (gathering information without directly interacting with the target) and <strong className="text-emerald-600 dark:text-emerald-400">active reconnaissance</strong> (directly probing the target's systems). Effective reconnaissance can reveal hidden assets, misconfigurations, exposed credentials, and third-party relationships that attackers exploit to gain initial access.
        </p>
      </div>
    </section>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Passive vs Active Reconnaissance</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Passive Reconnaissance */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Passive Reconnaissance</h3>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Active Reconnaissance</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Reconnaissance Phases (PTES Framework)</h2>

      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6 mb-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      <div className="space-y-4">
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-2">1. Footprinting (Initial Discovery)</h3>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-2">2. Network Enumeration</h3>
          <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-2">3. Service Identification</h3>
          <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-2">4. Information Consolidation</h3>
          <p className="text-gray-600 dark:text-gray-300">
    ...
    <section>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Target Corporation (2013)</h3>
          <div className="space-y-2 text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Reconnaissance Method:</strong> Attackers researched Target's third-party vendors through OSINT, identifying Fazio Mechanical Services (HVAC contractor) as a weak link.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Attack Vector:</strong> Phishing attack against Fazio employees followed by lateral movement into Target's network through vendor VPN access.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Impact:</strong> 40 million credit/debit cards stolen, 70 million customer records compromised.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Financial Cost:</strong> $292 million (settlements, legal fees, remediation).</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Key Lesson:</strong> Third-party reconnaissance reveals supply chain vulnerabilities that bypass direct security controls.</p>
          </div>
        </div>

        {/* SolarWinds Supply Chain Attack (2020) */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">SolarWinds Supply Chain Attack (2020)</h3>
          <div className="space-y-2 text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Reconnaissance Method:</strong> APT29 (Cozy Bear) conducted extensive passive reconnaissance of SolarWinds' software development infrastructure, identifying the Orion platform as a high-value target used by 18,000+ customers including Fortune 500 companies and government agencies.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Attack Vector:</strong> Compromised SolarWinds build system to inject SUNBURST backdoor into legitimate software updates.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Impact:</strong> 18,000+ organizations installed trojanized updates; 100+ high-profile victims including Microsoft, FireEye, US Treasury, Department of Homeland Security.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Financial Cost:</strong> Estimated $100 million+ in remediation costs across affected organizations.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Key Lesson:</strong> Deep reconnaissance of software supply chains enables wide-scale compromise through trusted update mechanisms.</p>
          </div>
        </div>

        {/* OPM Data Breach (2015) */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">US Office of Personnel Management (2015)</h3>
          <div className="space-y-2 text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Reconnaissance Method:</strong> Chinese APT conducted extensive reconnaissance of OPM's network architecture, identifying outdated systems and unpatched vulnerabilities. Attackers mapped network topology over several months.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Attack Vector:</strong> Exploited unpatched servers and stolen contractor credentials to access security clearance databases.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Impact:</strong> 21.5 million background investigation records stolen, including SF-86 forms with highly sensitive personal information.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Financial Cost:</strong> $133 million (initial response) + long-term national security implications.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Key Lesson:</strong> Patient, methodical reconnaissance enables attackers to map entire networks and identify critical assets before striking.</p>
          </div>
        </div>

        {/* Colonial Pipeline (2021) */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Colonial Pipeline Ransomware (2021)</h3>
          <div className="space-y-2 text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Reconnaissance Method:</strong> DarkSide ransomware group discovered Colonial Pipeline's exposed VPN credentials in dark web credential dumps. No 2FA was required for VPN access.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Attack Vector:</strong> Used compromised VPN credentials to access internal network and deploy ransomware across IT systems.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Impact:</strong> 5,500-mile pipeline shut down for 6 days, causing fuel shortages across US East Coast.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Financial Cost:</strong> $4.4 million ransom paid (partially recovered), $2.3 billion economic impact.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Key Lesson:</strong> Exposed credentials discovered through passive reconnaissance (credential dumps, breach databases) enable direct network access.</p>
          </div>
        </div>

        {/* Equifax Breach (2017) */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Equifax Data Breach (2017)</h3>
          <div className="space-y-2 text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Reconnaissance Method:</strong> Attackers scanned internet-facing Equifax systems for known vulnerabilities, identifying unpatched Apache Struts CVE-2017-5638.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Attack Vector:</strong> Exploited Apache Struts vulnerability in customer dispute portal to gain initial access, then moved laterally for 76 days.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Impact:</strong> 147 million consumers' personal data compromised (SSNs, birth dates, addresses, driver's licenses).</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Financial Cost:</strong> $1.4 billion in settlements and remediation.</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Key Lesson:</strong> Active reconnaissance (vulnerability scanning) of public-facing systems reveals unpatched exploits that enable initial compromise.</p>
          </div>
        </div>
      </div>
    </section>

    {/* MITRE ATT&CK RECONNAISSANCE TACTICS (TA0043) - UNIQUE SECTION */}
    <section>
      <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1589: Gather Victim Identity Information</h4>
          <p className="text-gray-600 dark:text-gray-300">Employee names, email addresses, credentials from breaches, organizational hierarchy.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1590: Gather Victim Network Information</h4>
          <p className="text-gray-600 dark:text-gray-300">IP ranges, domain names, network topology, DNS records, certificate data.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1591: Gather Victim Org Information</h4>
          <p className="text-gray-600 dark:text-gray-300">Business relationships, physical locations, organizational structure, business operations.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1592: Gather Victim Host Information</h4>
          <p className="text-gray-600 dark:text-gray-300">Operating systems, software versions, hardware configurations, security software.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1593: Search Open Websites/Domains</h4>
          <p className="text-gray-600 dark:text-gray-300">Social media, search engines, code repositories, business directories.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1594: Search Victim-Owned Websites</h4>
          <p className="text-gray-600 dark:text-gray-300">Corporate websites, job postings, technical blogs, partner portals.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1595: Active Scanning</h4>
          <p className="text-gray-600 dark:text-gray-300">Port scanning, vulnerability scanning, IP address scanning.</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">T1596: Search Open Technical Databases</h4>
          <p className="text-gray-600 dark:text-gray-300">WHOIS, DNS databases, certificate transparency logs, Shodan/Censys.</p>
        </div>
      </div>
    </section>
...
const LabTab = () => (
  <div className="space-y-8">
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Hands-On Reconnaissance Labs</h2>
    ...
    {/* LAB 1: PASSIVE OSINT */}
    <section>
      <h2 className="text-2xl font-bold mb-4">Lab 1: Passive OSINT Reconnaissance</h2>
      <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">WHOIS Lookup</h3>
...
<span className="text-gray-500"># - Physical address (if not privacy-protected)</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">DNS Enumeration (Passive)</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-blue-400">dig</span> -x 93.184.216.34
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Certificate Transparency Logs</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-gray-500"># admin.example.com</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Shodan & Censys (Internet Scanning Databases)</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-green-400"># Reveals exposed services, versions, vulnerabilities</span>
    ...
    <section>
      <h2 className="text-2xl font-bold mb-4">Lab 2: Active Network Reconnaissance</h2>
      <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Nmap Port Scanning</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-gray-500"># 3306/tcp  open  mysql      MySQL 5.7.30</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Banner Grabbing (Service Identification)</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-green-400"># Reveals software versions vulnerable to known CVEs</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">DNS Zone Transfer (AXFR)</h3>
          <div className="bg-gray-900 dark:bg-slate-950 rounded p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
...
<span className="text-green-400"># Defense: Restrict zone transfers to authorized secondary DNS servers only</span>
    ...
    {/* LAB 3: AUTOMATED OSINT */}
    <section>
      <h2 className="text-2xl font-bold mb-4">Lab 3: Automated OSINT with theHarvester</h2>
      <p className="text-gray-600 dark:text-gray-300 mb-4">
...
const ToolsTab = () => (
  <div className="space-y-8">
    <section>
      <h2 className="text-2xl font-bold mb-4">Reconnaissance & Defense Tools</h2>
    </section>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Nmap */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Nmap (Network Mapper)</h4>
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Comprehensive network reconnaissance</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> NSE scripting, stealth scanning, version detection</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Detection Risk:</strong> High (triggers IDS/IPS)</p>
          </div>
        </div>

        {/* theHarvester */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">theHarvester</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Passive information gathering</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Sources:</strong> Google, LinkedIn, Shodan, crt.sh, Bing</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Detection Risk:</strong> None (fully passive)</p>
          </div>
        </div>

        {/* Shodan */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Shodan</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Passive asset discovery</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> Vulnerability search, historical data, API access</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Cost:</strong> Free tier + paid plans ($49-$899/mo)</p>
          </div>
        </div>

        {/* Censys */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Censys</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Attack surface mapping</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> Certificate search, cloud asset discovery</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Cost:</strong> Free community edition + enterprise plans</p>
          </div>
        </div>

        {/* Recon-ng */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Recon-ng</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
            Metasploit-style OSINT framework with modular reconnaissance capabilities. Automates queries to 80+ data sources.
          </p>
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Modular OSINT automation</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Modules:</strong> WHOIS, DNS, social media, breach databases</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Output:</strong> Database storage, CSV/JSON export</p>
          </div>
        </div>

        {/* Maltego */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Maltego</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Relationship mapping and visualization</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> Entity linking, social network analysis</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Cost:</strong> Community edition (limited) + Commercial licenses</p>
          </div>
        </div>

        {/* Amass */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">OWASP Amass</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Subdomain discovery and network mapping</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Methods:</strong> Passive DNS, certificate transparency, APIs, brute force</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Output:</strong> Graph visualization, JSON export</p>
          </div>
        </div>

        {/* SpiderFoot */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">SpiderFoot</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
            Automated OSINT reconnaissance tool with web UI. Queries 200+ data sources and presents findings in interactive dashboard.
          </p>
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Use Case:</strong> Comprehensive automated OSINT</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> Correlation engine, threat intelligence integration</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Interface:</strong> Web UI + CLI</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Attack Surface Management (ASM)</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Discover assets before attackers do</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Features:</strong> Shadow IT discovery, risk scoring, remediation workflows</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Providers:</strong> CyCognito, Censys, Randori, Cortex Xpanse</p>
          </div>
        </div>

        {/* Honeypots */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Honeypots & Canary Tokens</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Detect reconnaissance and scanning</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Types:</strong> Network honeypots, email canaries, document traps</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Tools:</strong> Thinkst Canary, OpenCanary, HoneyDB</p>
          </div>
        </div>

        {/* Certificate Transparency Monitoring */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Certificate Transparency Monitoring</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Detect phishing domains and shadow IT</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Alerts:</strong> New subdomains, lookalike domains, wildcard certs</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Tools:</strong> CertStream, crt.sh, SSLMate</p>
          </div>
        </div>

        {/* IDS/IPS */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Intrusion Detection/Prevention (IDS/IPS)</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Detect and block active scanning</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Signatures:</strong> Nmap fingerprints, rapid port scans, banner grabbing</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Tools:</strong> Snort, Suricata, Zeek, Cisco Firepower</p>
          </div>
        </div>

        {/* SIEM */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">SIEM (Security Information & Event Management)</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Correlate multi-stage reconnaissance activities</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Detection:</strong> Sequential scanning, WHOIS/DNS queries, failed auth attempts</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Platforms:</strong> Splunk, Elastic, QRadar, Sentinel</p>
          </div>
        </div>

        {/* Threat Intelligence */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
          <h4 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Threat Intelligence Platforms</h4>
          <p className="text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <p><strong className="text-emerald-600 dark:text-emerald-400">Purpose:</strong> Preemptive blocking of known reconnaissance sources</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Feeds:</strong> Scanner IPs, Shodan crawlers, malicious domains</p>
            <p><strong className="text-emerald-600 dark:text-emerald-400">Providers:</strong> Recorded Future, Anomali, ThreatConnect, MISP</p>
          </div>
        </div>
      </div>
    </section>
...
const ReferencesTab = () => (
  <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">MITRE ATT&CK TA0043: Reconnaissance</h4>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">PTES (Penetration Testing Execution Standard)</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">NIST SP 800-115: Technical Guide to Information Security Testing</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">OWASP Web Security Testing Guide</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
    ...
    {/* TOOLS & PLATFORMS */}
    <section>
      <h3 className="text-2xl font-bold mb-4">Tools & Platforms</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">Censys</h4>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">OWASP Amass</h4>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">crt.sh</h4>
    ...
    {/* PRACTICE PLATFORMS */}
    <section>
      <h3 className="text-2xl font-bold mb-4">Practice Platforms (Legal Targets)</h3>
      <div className="space-y-3">
        <a
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">Hack The Box</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">TryHackMe</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold">Offensive Security Labs</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
