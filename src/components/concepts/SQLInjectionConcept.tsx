        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-cyan-300 mt-2">Master one of the most dangerous web vulnerabilities</p>
            </div>
            {onStartChallenge && (
              <button
    ...
    <section>
      ...
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        ...
        <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-4">
          <p className="text-sm font-semibold mb-2">OWASP Top 10 Classification</p>
      ...
      <div className="bg-red-500/20 border-l-4 border-red-500 rounded-lg p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">100+ Million Records Exposed</h3>
            <p className="text-gray-200 leading-relaxed">
...
?>`}</code>
          ...
          <div className="mt-3 bg-red-500/20 rounded-lg p-3">
            ...
            <p className="text-sm text-gray-200">
              ...
              An attacker can input <code className="bg-black/30 px-2 py-1 rounded">' OR '1'='1' --</code>
...
// Attack: /user/1 OR 1=1`}</code>
    ...
    <section>
      ...
      <div className="bg-white/5 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-3">Classic Bypass: <code className="text-cyan-400">' OR '1'='1' --</code></h3>

        <div className="space-y-4">
          <div>
            <p className="text-sm text-gray-300 mb-2">Original SQL Query:</p>
          ...
          <div>
            <p className="text-sm text-gray-300 mb-2">After Injection (username field):</p>
            <div className="bg-black/50 rounded p-3 font-mono text-sm">
              <code className="text-gray-300">
          ...
          <div>
            <p className="text-sm text-gray-300 mb-2">What happens:</p>
            <div className="bg-blue-500/20 rounded p-3">
              <ol className="list-decimal list-inside space-y-2 text-sm text-gray-200">
                ...
                <li><code className="bg-black/30 px-1">OR '1'='1'</code> makes the condition always TRUE</li>
                <li><code className="bg-black/30 px-1">--</code> comments out the rest of the query (including password check)</li>
      ...
      <div className="bg-white/5 rounded-lg p-6 space-y-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <div className="bg-black/50 rounded p-3 font-mono text-sm">
              <code className="text-green-400">' ORDER BY 1 --</code><br />
              <code className="text-green-400">' ORDER BY 2 --</code><br />
          ...
          <div>
            ...
            <div className="bg-black/50 rounded p-3 font-mono text-sm">
              <code className="text-green-400">' UNION SELECT NULL, NULL, NULL --</code><br />
              <code className="text-green-400">' UNION SELECT 'test', NULL, NULL --</code>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-black/50 rounded p-3 font-mono text-sm">
              <code className="text-green-400">' UNION SELECT table_name, NULL, NULL FROM information_schema.tables --</code><br />
              <code className="text-green-400">' UNION SELECT username, password, NULL FROM users --</code>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <p className="font-semibold text-cyan-400">SQLi Testing Features:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <p className="font-semibold text-cyan-400">SQLi Capabilities:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300">
    ...
    <section>
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-black/30 rounded p-4">
              <p className="text-sm font-semibold mb-2 text-cyan-400">PHP PDO</p>
            ...
            <div className="bg-black/30 rounded p-4">
              <p className="text-sm font-semibold mb-2 text-cyan-400">Python</p>
              <div className="bg-black/50 rounded p-2 font-mono text-xs">
                <code className="text-gray-300">
            ...
            <div className="bg-black/30 rounded p-4">
              <p className="text-sm font-semibold mb-2 text-cyan-400">Node.js</p>
              <div className="bg-black/50 rounded p-2 font-mono text-xs">
                <code className="text-gray-300">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 border border-blue-500/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">Validation Examples:</p>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded p-3">
              ...
              <p className="text-xs text-gray-300">Open-source WAF with OWASP Core Rule Set (CRS)</p>
            </div>
            <div className="bg-white/5 rounded p-3">
              <p className="font-semibold mb-1">Cloudflare WAF</p>
              <p className="text-xs text-gray-300">Cloud-based protection with managed rulesets</p>
            </div>
            <div className="bg-white/5 rounded p-3">
              <p className="font-semibold mb-1">AWS WAF</p>
              <p className="text-xs text-gray-300">Customizable rules for AWS-hosted applications</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">Detection & Monitoring:</p>
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-300">
            ...
            <div>
              <p className="text-sm font-semibold mb-2 text-cyan-400">Error Handling:</p>
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-300">
    ...
    <section>
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <p className="text-xs text-cyan-400">https://owasp.org/www-community/attacks/SQL_Injection</p>
        </a>
        ...
        >
          ...
          <p className="text-xs text-purple-400">https://cwe.mitre.org/data/definitions/89.html</p>
        </a>
        ...
        >
          ...
          <p className="text-xs text-green-400">https://cheatsheetseries.owasp.org/...</p>
        </a>
      </div>
    </section>
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-red-500/50 rounded-lg p-5">
          ...
          <div className="bg-black/30 rounded p-4 mb-3">
            <p className="text-xs font-semibold mb-2 text-cyan-400">Key Takeaways:</p>
    ...
    <section>
      ...
      <div className="space-y-3">
        <div className="bg-white/5 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-400 mb-2">W. Halfond, J. Viegas, A. Orso (2006)</p>
        ...
        <div className="bg-white/5 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-400 mb-2">W. Halfond, A. Orso (2005)</p>
          <p className="text-xs text-gray-300">
        ...
        <div className="bg-white/5 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-400 mb-2">K. Kemalis, T. Tzouramanis (2008)</p>
          <p className="text-xs text-gray-300">
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-cyan-400">Open Source • Practice Environment</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-purple-400">Educational • Progressive Difficulty</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-green-400">Free • Interactive Labs</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/50 rounded-lg p-5">
          ...
          <span className="text-xs text-orange-400">CTF Style • Real-World Scenarios</span>
        </div>
      </div>
    </section>
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Complete guide to automated SQL injection exploitation</p>
            </div>
            <a
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Comprehensive collection of SQL injection payloads and techniques</p>
            </div>
            <a
        ...
        <div className="bg-white/5 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Methodology for testing applications for SQL injection vulnerabilities</p>
            </div>
            <a
